...
const page = () => {
  ...
  return (
    <div className='flex flex-col-reverse  md:flex-row justify-between container mt-2'>
      ...
      <CardHeader>
        ...
        <CardDescription className='break-words'>{room && room.description}</CardDescription>
      </CardHeader> 
      <CardContent>
